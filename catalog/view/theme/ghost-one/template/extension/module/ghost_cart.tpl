<div class="col-md-9 col-sm-12 col-xs-12 cart__content">
...
<div class="col-md-3 col-sm-12 col-xs-12 cart-sidebar">
    ...
    <div class="cart-sidebar__body">
        ...
        <?php if ($custom_total <= 1500 - 1) { ?>
            <div class="btn_orange cart-sidebar__btn-checkout btn-js-checkout cart-sidebar__btn-checkout_disabled">
                Оформить заказ
            </div>
        <?php } else { ?>
            <?php if ($redirect_checkout) { ?>
                <div class="btn_orange cart-sidebar__btn-checkout btn-js-checkout"
                    <?php echo $redirect_checkout; ?>>
                    Оформить заказ
                </div>
            <?php } else { ?>
                <div class="btn_orange cart-sidebar__btn-checkout btn-js-checkout"
