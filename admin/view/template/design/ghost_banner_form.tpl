              ...
              <table id="images<?php echo $language['language_id']; ?>" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr id="image-row<?php echo $image_row; ?>">
                    ...
                    <td class="text-left"><input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][tag]" value="<?php echo $banner_image['tag']; ?>" placeholder="<?php echo $entry_tag; ?>" class="form-control" />
                    <td class="text-left"><input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][text]" value="<?php echo $banner_image['text']; ?>" placeholder="<?php echo $entry_text; ?>" class="form-control" />
